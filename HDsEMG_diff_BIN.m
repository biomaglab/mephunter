function output = HDsEMG_diff_BIN()
...
configuration.patient_id = info_patient.id;
...
for i = 1:size(signal.emg_data_diff, 2)
     signal.emg_map{i} = signal.emg_data_diff(:, i);
end

configuration.emg_mode = {'Diff'};
